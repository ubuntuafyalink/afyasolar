  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center animate-in fade-in duration-300">
      <div className="text-center">
        <div
          className="w-12 h-12 border-[3px] border-primary/20 border-t-primary rounded-full animate-spin mx-auto mb-4"
          aria-hidden
        />
...
export function ManagementPanelDashboardSkeleton() {
  return (
    <div className="h-full overflow-y-auto scroll-smooth animate-in fade-in duration-300">
      ...
      <Card className="rounded-lg border-border shadow-sm overflow-hidden mb-6">
...
export function ManagementPanelErrorState({
  ...
  return (
    <div className={cn('min-h-[40vh] flex items-center justify-center p-6 animate-in fade-in duration-300', className)}>
      <Card className="max-w-md w-full border-warning/40 bg-warning/10 shadow-sm">
        <CardContent className="pt-6">
          <div className="flex items-start gap-4 text-warning-foreground">
            <div className="rounded-full bg-warning/20 p-2.5 shrink-0">
              <AlertCircle className="w-5 h-5 text-warning-foreground" aria-hidden />
            </div>
